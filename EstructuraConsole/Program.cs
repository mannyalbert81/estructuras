...
namespace EstructuraConsole
{
    class Program
    {
        ...
        public static void InsertaEstructuras()
        {
            ...
            if (regCabeza > 0)
            {
                foreach (DataRow renglon in dtCabeza.Rows)
                {
                    ...
                    {
                        //1
                        string _tipo_identificacion_eres_04 = "P";
                        ...
                        double _interes_sobre_mora_eres_04;
                        double _demanda_judicial_eres_04;
                        double _cartera_castigada_eres_04;
                        double _provision_requerida_original_eres_04;
                        double _provision_requerida_reducida_eres_04;
                        double _provision_constituida_eres_04;
                        string _tipo_operacion_eres_04;
                        string _objeto_fedeicomiso_eres_04;
                        double _prima_o_descuento_eres_04;
                        double _cuota_credito_eres_04;
                    }
                    else
                    {
        ...
        public static double DevuelveSaldoActual(string _tipo, string _numero_operacion, double _saldo_actual_ere, string _year, string _mes)
        {
            ...
            {
                numero_operacion = "SOBR" + _numero_operacion.Replace(_mes+_year, "");
            }
            ...
            ///BUSCO LA FECHA
            /// 
            string where = "   numero_operacion = '" + numero_operacion + "' AND extract(MONTH  FROM fecha_pago_abono) = '" + Convert.ToInt16(_mes) + "'  AND extract(YEAR  FROM fecha_pago_abono) = '" + Convert.ToInt32(_year) + "'  ";
            string tabla = "abonos";
